...
% allow for ſ character ('long s') through new \longs command.
% the `notext` option prevents the ſ character from turning up uninvited in default text fonts.
\usepackage[veryoldstyle, notext]{kpfonts}      
